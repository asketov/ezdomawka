        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Connection = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailDomainInstitutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MailDomainInstitutes_Institutes_InstituteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Connection = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavorSolutions_Institutes_InstituteId",
                        column: x => x.InstituteId,
                        principalTable: "Institutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UpdateFavorHistory_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteFavors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteFavors_FavorSolutions_Id",
                        column: x => x.Id,
                        principalTable: "FavorSolutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteFavors_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavorSubjects", x => new { x.FavorSolutionId, x.SubjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavorSolutions_InstituteId",
                table: "FavorSolutions",
                column: "InstituteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavorSubjects_SubjectId",
                table: "FavorSubjects",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_MailDomainInstitutes_InstituteId",
                table: "MailDomainInstitutes",
                column: "InstituteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Themes_InstituteId",
                table: "Themes",
                column: "InstituteId");

            migrationBuilder.CreateIndex(
                name: "IX_UpdateFavorHistory_AuthorId",
